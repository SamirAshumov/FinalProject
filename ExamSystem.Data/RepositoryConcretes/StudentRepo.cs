...
namespace ExamSystem.Data.RepositoryConcretes
{
    public class StudentRepo : IStudentRepo
    {
        ...
        {
            var answer = _context.Answers.FirstOrDefault(a => a.StudentId == StudentId && a.ExamId == ExamId);
            return answer;
        }
        ...
        {
            var studentAsnwer = _context.Answers.FirstOrDefault(A => A.StudentId == StudentId);
